    ...
    <div className="dashboard-container fade-in">
      ...
      <div className="properties-list-container">
        {leads.length > 0 ? (
          ...
          <div className="premium-card" style={{ padding: "48px 24px", textAlign: "center", borderRadius: "16px" }}>
            <div style={{ fontSize: "40px", marginBottom: "12px" }}>📬</div>
            <h3 style={{ fontSize: "18px", fontWeight: "700", marginBottom: "6px" }}>No buyer inquiries yet</h3>
            <p style={{ color: "var(--text-secondary)", fontSize: "13px", maxWidth: "450px", margin: "0 auto 20px" }}>
              When interested buyers unlock your property contact information, their details and phone numbers will appear here.
            </p>
            <a href="/dashboard/properties" className="btn-primary" style={{ display: "inline-flex", padding: "10px 24px", textDecoration: "none", borderRadius: "8px", fontWeight: "600" }}>
              Manage My Listings
            </a>
          </div>
        )}
